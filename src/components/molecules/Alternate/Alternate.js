      ...
      <View>
        <View style={{marginTop: '8%'}}>
          ...
          <View
            ...
            <Text
              ...
              {Local('doctor.availablity.start_time')}
            </Text>
            <TextInputMask
              type={'datetime'}
              options={{
          ...
          <View
            ...
            <Text
              ...
              {Local('doctor.availablity.end_time')}
            </Text>
            <TextInputMask
              type={'datetime'}
              options={{
        ...
        <View style={{marginTop: '8%'}}>
          ...
          <View
            ...
            <Text style={{color: Colors.primary_text_color[theme]}}>
              {Local('doctor.availablity.start_time')}
            </Text>
            <TextInputMask
              type={'datetime'}
          ...
          <View style={{}}>
            <View style={{flexDirection: 'row'}}>
              <Text
                ...
                {Local('doctor.availablity.monday')}
              </Text>
              <CheckBox
            ...
            <View style={{flexDirection: 'row'}}>
              <Text
                ...
                {Local('doctor.availablity.wednesday')}
              </Text>
              <CheckBox
            ...
            <View style={{flexDirection: 'row'}}>
              <Text
                ...
                {Local('doctor.availablity.friday')}
              </Text>
              <CheckBox
                name="weekDays"
            ...
            <View style={{flexDirection: 'row'}}>
              <Text
                ...
                {Local('doctor.availablity.sunday')}
              </Text>
              <CheckBox
                name="weekDays"
          ...
          <View style={{}}>
            <View style={{flexDirection: 'row'}}>
              <Text
                ...
                {Local('doctor.availablity.tuesday')}
              </Text>
              <CheckBox
            ...
            <View style={{flexDirection: 'row'}}>
              <Text
                ...
                {Local('doctor.availablity.thursday')}
              </Text>
              <CheckBox
                name="weekDays"
            ...
            <View style={{flexDirection: 'row'}}>
              <Text
                ...
                {Local('doctor.availablity.saturday')}
              </Text>
              <CheckBox
                name="weekDays"
        ...
        <View
          style={{flexDirection: 'row', marginBottom: 10, marginLeft: '8%'}}>
          {!hideAdd && (
